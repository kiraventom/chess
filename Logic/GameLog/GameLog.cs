...
public class GameLog
{
    ...
    public void AddMove(Piece piece, Move move, bool isTake, bool isCheck, bool isMate, bool isCastle, IEnumerable<Position> extra)
    {
        var logMove = new GameLogMove(move, piece, isTake, isCheck, isMate, isCastle, extra);
